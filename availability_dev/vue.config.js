 ...
 */
module.exports = {
	publicPath: process.env.NODE_ENV === "development" ? "" : "view/availability",
	outputDir: "../view/availability",
	indexPath: "../availability.html",
	chainWebpack: config => {
		config.output.chunkFilename(`js/[name].[id].[chunkhash:8].js`)
		config.plugin("html").tap(args => {
			args[0].title = "Disponibilité informatique"
			return args
		})
	},
	configureWebpack: {
